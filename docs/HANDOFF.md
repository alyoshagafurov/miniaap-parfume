...
Нажмите «Нет в списке — создать» прямо в форме товара.
...
**Много фотографий сразу:** раздел **Фото** в меню — там можно грузить на
несколько товаров подряд, не заходя в каждый.
...
**Импорт.** Кнопка **Выбрать файл**, дальше `.xlsx` или `.csv`.
